...
-- Registrar el agente en el Snowflake Intelligence Object para que aparezca en la UI de chat
-- (idempotente: removemos primero por si ya estaba registrado)
...
-- Permitir que cualquier rol pueda ver la lista de agentes en Snowflake Intelligence
